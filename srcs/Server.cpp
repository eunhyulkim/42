...
Server::Server() {}
Server::Server(ServerManager* server_manager, int server_fd, const std::string& server_block, std::vector<std::string>& location_blocks, Config* config)
{
	...
	m_default_error_page = server_map["DEFAULT_ERROR_PAGE"];
