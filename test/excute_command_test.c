...
//		if (table->before)
//		{
//			if (table->sep_state == AND_OPERATOR)
//			{
//				if (table->before->res == TRUE)
//				{
//					execute_redirection(table);
//					table->res = execute_command(table);
//				}
//				else
//				{
//					table->res = FALSE;
...
//				}
//			}
//			else if (table->sep_state == OR_OPERATOR)
//			{
//				if (table->before->res == TRUE)
//				{
//					table->res = TRUE;
...
//				}
//			}
//			else if (table->sep_test == SEMICOLON)
//			{
//					execute_redirection(table);
//					table->res = execute_command(table);
//			}
