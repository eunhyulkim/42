...
void OfficeBlock::set_m_intern(Intern const &intern) { this->m_intern = &intern; }
void OfficeBlock::set_m_signer(Bureaucrat const &signer) { this->m_signer = &signer; }
void OfficeBlock::set_m_executor(Bureaucrat const &executor) { this->m_executor = &executor; }
