...
Fixed& Fixed::min(Fixed& n, Fixed& m) {return ((n <= m) ? n : m);}
const Fixed& Fixed::min(const Fixed& n, const Fixed& m) {return ((n <= m) ? n : m);}
Fixed& Fixed::max(Fixed& n, Fixed& m) {return ((n >= m) ? n : m);}
const Fixed& Fixed::max(const Fixed& n, const Fixed& m) {return ((n >= m) ? n : m);}
